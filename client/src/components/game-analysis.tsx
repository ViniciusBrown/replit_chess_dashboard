...
// Format a number with toFixed, safely handling null/undefined
const safeFormat = (value?: number | null, digits: number = 0): string => {
  if (value === undefined || value === null) return '0';
  return value.toFixed(digits);
};

// Safely get a percentage for CSS width, handling nulls
const safePercentage = (value?: number | null): string => {
  if (value === undefined || value === null) return '0%';
  return `${value}%`;
};
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {hasGameAnalysis && analysis?.game?.accuracy !== undefined && (
                  <div className="bg-neutral-100 rounded-lg p-3 text-center">
                    <div className="text-2xl font-bold text-primary">{safeFormat(analysis.game.accuracy)}%</div>
              ...
              <div className="space-y-4">
                {hasFundamentalsAnalysis && analysis?.fundamentals?.pawnStructure !== undefined && (
                  <div className="relative pt-1">
                    ...
                    <div className="overflow-hidden h-2 mb-1 text-xs flex rounded bg-neutral-200">
                      <div 
                        style={{ width: safePercentage(analysis.fundamentals.pawnStructure) }} 
                ...
                {hasGameAnalysis && analysis?.game?.accuracy !== undefined && (
                  <div className="relative pt-1">
                    ...
                    <div className="overflow-hidden h-2 mb-1 text-xs flex rounded bg-neutral-200">
                      <div 
                        style={{ width: safePercentage(analysis.game.accuracy) }} 
                        className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary"
                      ></div>
                    </div>
                  </div>
                ...
                {hasOpeningsAnalysis && analysis?.openings?.accuracy !== undefined && (
                  <div className="relative pt-1">
                    ...
                    <div className="overflow-hidden h-2 mb-1 text-xs flex rounded bg-neutral-200">
                      <div 
                        style={{ width: safePercentage(analysis.openings.accuracy) }} 
                        className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary"
                      ></div>
                    </div>
                  </div>
            ...
            <div className="mb-6">
              ...
              {analysis?.game?.accuracy !== undefined && analysis.game.blunders !== undefined && 
                ...
                <p className="text-sm text-neutral-600 mb-4">
                  Analysis of your game shows an accuracy of <span className="font-medium">{safeFormat(analysis.game.accuracy)}%</span>.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {analysis?.openings?.accuracy !== undefined && (
                    <div>
                      ...
                      <p className="text-sm font-medium">{safeFormat(analysis.openings.accuracy)}%</p>
                    </div>
                  )}
                </div>
              </div>
                    ...
                    <CardContent className="pt-6">
                      ...
                      <div className="relative pt-1">
                        ...
                        <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-neutral-200">
                          <div 
                            style={{ width: safePercentage(analysis.fundamentals.pieceDevelopment) }} 
                            className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary"
                          ></div>
                        </div>
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      ...
                      <div className="relative pt-1">
                        ...
                        <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-neutral-200">
                          <div 
                            style={{ width: safePercentage(analysis.fundamentals.centerControl) }} 
                            className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary"
                          ></div>
                        </div>
                        <p className="text-xs text-neutral-600">
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      ...
                      <div className="relative pt-1">
                        ...
                        <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-neutral-200">
                          <div 
                            style={{ width: safePercentage(analysis.fundamentals.kingSafety) }} 
                            className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary"
                          ></div>
                        </div>
                        <p className="text-xs text-neutral-600">
